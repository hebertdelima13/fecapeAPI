...
export class default1672926327888 implements MigrationInterface {
    name = 'default1672926327888'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "championships" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "registered" integer NOT NULL, "typeOfChamp" text NOT NULL, "category" text NOT NULL, "step" text NOT NULL, CONSTRAINT "UQ_4263776de1abe4910604a517c1f" UNIQUE ("name"), CONSTRAINT "PK_0f99e3669ee9b045b47cc8c916d" PRIMARY KEY ("id"))`);
